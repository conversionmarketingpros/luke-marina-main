...
export function PrivacyPolicyHeroSection() {
  return (
    <section
      ...
      style={{
        backgroundImage: ` url('/images/68d33a604b657668b639c8dc.jpeg')`,
      ...
      <div className="relative z-10 flex-1 flex items-center justify-start">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-2xl">
            <h1 className="text-2xl mr-12 md:mr-0 sm:text-3xl md:text-4xl lg:text-6xl font-bold text-white mb-4">Privacy Policy</h1>
